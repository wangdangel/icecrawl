...
describe('UserService', () => {
  ...
  describe('getUserById', () => {
    ...
    it('should return null and log error on exception', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'Error getting user by ID' }),
      );
    });
  });
  ...
  describe('getUserByUsernameInternal', () => {
    ...
    it('should return null and log error on exception', async () => {
      ...
      expect(result).toBeNull();
      expect(logger.error).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'Error getting internal user by username' }),
      );
    });
  });
  ...
  describe('getUserByEmailInternal', () => {
    it('should return full User if user is found by email', async () => {
      ...
      expect(result).toEqual(mockUser);
      expect(mockedPrismaUser.findFirst).toHaveBeenCalledWith({
    ...
    it('should return null and log error on exception', async () => {
      ...
      expect(result).toBeNull();
      expect(logger.error).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'Error getting internal user by email' }),
      );
    });
  });
  ...
  describe('getAllUsers', () => {
    ...
    it('should return empty array and 0 total on error', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'Error getting all users' }),
      );
    });
  });
  ...
  describe('createUser', () => {
    ...
    it('should throw specific error for username conflict', async () => {
      ...
      await expect(UserService.createUser(createData)).rejects.toThrow(
        `Username '${createData.username}' already exists.`,
      );
      expect(logger.error).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'Error creating user' }),
      );
    });
    ...
    it('should throw specific error for email conflict', async () => {
      ...
      await expect(UserService.createUser(createData)).rejects.toThrow(
        `Email '${createData.email}' already registered.`,
      );
      expect(logger.error).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'Error creating user' }),
      );
  ...
  describe('updateUser', () => {
    ...
    it('should throw specific error for username conflict on update', async () => {
      ...
      await expect(UserService.updateUser('user-1', updateData)).rejects.toThrow(
  ...
  describe('deleteUser', () => {
    ...
    it('should return false and log error on exception', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'Error deactivating user' }),
      );
    });
  });
  ...
  describe('permanentlyDeleteUser', () => {
    it('should permanently delete user', async () => {
      ...
      expect(logger.info).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'User permanently deleted' }),
      );
    });
    ...
    it('should return false if user not found (P2025 error)', async () => {
      ...
      expect(result).toBe(false);
      expect(logger.error).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'Error permanently deleting user' }),
      );
      expect(logger.warn).toHaveBeenCalledWith(
        expect.stringContaining('Attempted to permanently delete non-existent user'),
      );
    });
  ...
  describe('updateLastLogin', () => {
    ...
    it('should log error but not throw on exception', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        expect.objectContaining({ message: 'Failed to update last login time' }),
      );
    });
  });
});
