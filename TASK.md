...
- [x] Fix crawler extracting 0 links during crawl jobs (Added: 2025-04-07)
  ...
  - Single-page scrapes _do_ extract links correctly, suggesting the issue is specific to the crawl process integration.
...
- [x] Fix 'Recent Scrapes' not showing data (Added: 2025-04-06) - _Resolved by running migrations, DB was reset._
